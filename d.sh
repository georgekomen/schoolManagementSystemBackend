...
ssh 35.237.90.117 docker pull gcr.io/arafat-project/arafat-project
ssh 35.237.90.117 docker stop arafat-project
ssh 35.237.90.117 docker rm arafat-project
ssh 35.237.90.117 docker run -d -p 9000:5000 --name arafat-project --restart always gcr.io/arafat-project/arafat-project
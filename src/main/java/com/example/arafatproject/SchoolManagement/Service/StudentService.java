...
public interface StudentService {
    String uploadFingerprint(Long studentId, Identification.IdentificationType fingerType, StudentController.ActionType action, MultipartFile file) throws IOException;
